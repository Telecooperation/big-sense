...
import de.tudarmstadt.tk.dbsystel.bluetoothmeasurement.connection.HTTPFunctions;
import de.tudarmstadt.tk.dbsystel.bluetoothmeasurement.localdb.MeasurementDB;
import de.tudarmstadt.tk.dbsystel.bluetoothmeasurement.sensors.PositionManager;
import de.tudarmstadt.tk.dbsystel.bluetoothmeasurement.sensors.Bluetooth;
...
public class CollectAndSend {
    ...
    public void makeMeasurement() {
        ...
        if(((StartService.ONLY_MEASURE_WHILE_MOVING && locationHasMoved) ||
                    ...
                    && bluetooth.getLastValuesForMeasurement() && location != null) {
            lastSavedLocation = location;

            List<Measurement> newNetworks = bluetooth.getMeasurements();
