    ...
    public PositionManager(Context context) {
        ...
        LocationListener locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                else if(lastKnownLocation != null && (location.getTime() - lastKnownLocation.getTime()) > 2000 * StartService.MIN_GPS_UPDATE_INTERVAL_SEC) {
                    lastKnownLocation = location;
        ...
        locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, StartService.MIN_GPS_UPDATE_INTERVAL_SEC * 1000, StartService.MIN_GPS_UPDATE_DISTANCE_METER, locationListener);
